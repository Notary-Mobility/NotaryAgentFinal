...
public class MySession {
    ...
    public static final String APP_PUSH_SETTING = "getpushenable";
 ...
 */
    ...
    public void setPushSetting(boolean val){
        editor.putBoolean(APP_PUSH_SETTING, val);
        editor.commit();
    ...
    {
        return pref.getBoolean(APP_PUSH_SETTING, true);
    }
